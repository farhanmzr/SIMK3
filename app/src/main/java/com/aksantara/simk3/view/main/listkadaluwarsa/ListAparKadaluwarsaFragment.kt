package com.aksantara.simk3.view.main.listkadaluwarsa
...
class ListAparKadaluwarsaFragment : Fragment() {

    private lateinit var binding : FragmentListAparKadaluwarsaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListAparKadaluwarsaBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            ...
            Log.e("departemenNama", departemenNama.toString())
    ...
    private fun showDataAparRv(departemenId: String, departemenNama: String) {
        ...
        mainViewModel.getListDataAparKadaluwarsa(departemenId, departemenNama)
